...
class TerritoryCounterTest {
    ...
    void testNeutralTerritory() {
        ...
        assertTrue(totalClaimed < emptyPoints, 
            "Not all empty points are claimed (there are neutral ones)");
    }
    ...
    void testLargeBlackTerritory() {
        ...
        assertEquals(expectedTerritory, territory.get(Color.BLACK), 
    ...
    void testTerritoryAtBoardEdge() {
        ...
        assertTrue(territory.get(Color.BLACK) >= 4, 
            "Black has territory at the board edge");
    }
    ...
    void testTerritoryInCorner() {
        ...
        assertTrue(territory.get(Color.BLACK) >= 1, 
            "Black has territory in the corner");
    }
    ...
    void testNoTerritoryWithEvenDistribution() {
        ...
        assertEquals(0, territory.get(Color.BLACK), 
            "Black has no territory with even distribution");
        assertEquals(5, territory.get(Color.WHITE), 
            "White has 5, as they have taken 5 stones");
    }
    ...
    void testComplexTerritoryWithEyes() {
        ...
        assertEquals(2, territory.get(Color.BLACK), 
            "Black has 2 points of territory (two 'eyes')");
    }
    ...
    void testNoTerritoryWithStoneInside() {
        ...
        assertEquals(0, territory.get(Color.BLACK), 
            "Black has no territory if there is a black stone inside");
        assertEquals(0, territory.get(Color.WHITE), 
            "No territory");
    }
