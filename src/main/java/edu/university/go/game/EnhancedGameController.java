...
/**
 * Controller for managing the state of a Go game with enhanced features:
 * - Ko rule enforcement
 * - Score calculation with komi
 * - Captured stones tracking
 * - Game end conditions (two consecutive passes or resignation)
 */
public class EnhancedGameController {
    ...
    public boolean makeMove(int x, int y) {
        ...
        System.out.println("[" + currentColor + " move at (" + x + ", " + y + ")] Will capture: " + captured.size() + " stones");
        ...
        try {
            ...
            if (!captured.isEmpty()) {
                System.out.println("[" + currentColor + " move] Actually captured " + captured.size() + " stones!");
    ...
    public Color getCurrentTurn() { return game.getCurrentTurn(); }
    ...
    public void setBlackPlayerId(String playerId) { this.blackPlayerId = playerId; }
    public void setWhitePlayerId(String playerId) { this.whitePlayerId = playerId; }
