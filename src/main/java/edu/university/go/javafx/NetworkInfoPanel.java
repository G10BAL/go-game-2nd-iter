...
public class NetworkInfoPanel extends VBox {
    ...
    public NetworkInfoPanel(ClientApplication clientApp) {
        ...
        connectionStatusLabel.setStyle("-fx-text-fill: #e74c3c; -fx-font-weight: bold; -fx-font-size: 12;");
    ...
    public void updateConnectionStatus(String status, boolean connected) {
        ...
        connectionStatusLabel.setStyle("-fx-text-fill: " + (connected ? "#27ae60" : "#e74c3c") + "; -fx-font-weight: bold; -fx-font-size: 12;");
    }
